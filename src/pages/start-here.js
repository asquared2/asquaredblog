        ...
        <div className="container py-4">
          <div className="columns is-vcentered">
            <div className="column is-6">
              ...
              T'Challa, a member of the royal family of the fictional African country of Wakanda. After the death my father, I claimed the throne and the role of Black Panther. I was exposed to a mystical herb that enhanced my strength and agility to near-superhuman levels and awesomely. 
              </p>
            </div>
